...
pool.connect((err) => {
    if (err) {
        ...
        console.log('Connected to Sightguide Database')
    }
});
...
const theARRAYYY = [
    ...
    },
    {
        "fields": {
            ...
            "beschreibung": "The Colosseum (/ˌkɒləˈsiːəm/ KOL-ə-SEE-əm; Italian: Colosseo [kolosˈsɛːo]) is an elliptical amphitheatre in the centre of the city of Rome, Italy, just east of the Roman Forum. It is the largest ancient amphitheatre ever built, and is stil",
            "images": [
                {
                    "title": "colosseum",
